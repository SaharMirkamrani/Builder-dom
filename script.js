...
function paint() {
  ...
  comments.forEach(function (comment) {
    const card = builder.create("div").className("card").appendTo(main).build();
    const head = builder.create("div").className("head").appendTo(card).build();
    const text = builder
      .create("div")
      .text(`${comment.text}`)
      .className("text")
    ...
    const date = builder
      ...
      .appendTo(text)
      .build();
    const left = builder.create("div").className("left").appendTo(head).build();
    const image = builder
      .create("div")
      .className("image")
      .appendTo(left)
